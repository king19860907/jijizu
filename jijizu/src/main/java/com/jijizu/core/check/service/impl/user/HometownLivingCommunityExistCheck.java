 ...
 *******************************************************************************
 * @project : 集集组   
 * @type : LivingCommunityExistCheck
 * @function : 家乡生活小区存在检查-不存在则返回错误
 *******************************************************************************
 * @version ：1.1.0
 * @creator ：majun   
 * @date ：2013-1-27   
...
public class HometownLivingCommunityExistCheck extends CheckCommonField
	...
	public JsonResult check(Map<String, Object> para) {
		Object livingCommunityId = para.get(CheckParam.LIVINGCOMMUNITY);
