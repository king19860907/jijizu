...
public class PersoanalAuthNotExistCheck extends CheckCommonField
	...
	public JsonResult check(Map<String, Object> para) {
		...
		if(!ObjectUtil.isEmptyObject(userId)){
			if(authDAO.isHavePostPersonalAuth(Long.parseLong(userId.toString()))){
