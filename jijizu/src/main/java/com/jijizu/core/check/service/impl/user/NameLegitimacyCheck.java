...
public class NameLegitimacyCheck extends CheckCommonField
	...
	public JsonResult check(Map<String, Object> para) {
		...
		if(StringUtil.isNotNullOrEmpty(name)){
			if(Pattern.matches("^[a-zA-Z\u4e00-\u9fa5][a-zA-Z0-9\u4e00-\u9fa5_]+$", name)==false || illegalWordsCheck.checkIllegalword(name) == null
