...
import static com.jijizu.base.util.CollectionUtil.*;
...
public class ArrayUtil
{
    ...
    private static int arrayLength(Object array, int defaultIfNull,
            int defaultIfNotArray)
    {
        if (array == null)
        {
     ...
     * 
     * @param componentType
     *            <code>Iterable</code>元素的类型，必须和数组类型兼容。例如对于 <code>int[]</code>
     *            数组， <code>componentType</code>必须为 <code>Integer.class</code>。
     * @param array
     *            要转换的数组
     * @return 被创建的<code>Iterable</code>对象
     */
    public static <T> Iterable<T> arrayAsIterable(final Class<T> componentType,
            Object array)
    {
     ...
     *            要转换的数组
     * @param keyType
     *            key的类型，数组元素<code>keyValueArray[n][0]</code>的类型必须与之兼容
     * @param valueType
     *            value的类型，数组元素<code>keyValueArray[n][1]</code>的类型必须与之兼容
     * @return 被创建的map
     */
    public static <K, V> Map<K, V> arrayToMap(Object[][] keyValueArray,
     ...
     */
    public static <K, V> Map<K, V> arrayToMap(Object[][] keyValueArray,
            Class<K> keyType, Class<V> valueType, Map<K, V> map)
    {
    ...
    public static int arrayLastIndexOf(double[] array, double doubleToFind,
            double tolerance)
    {
        return arrayLastIndexOf(array, doubleToFind, Integer.MAX_VALUE,
                tolerance);
    }
    ...
    public static int arrayLastIndexOf(float[] array, float floatToFind,
            float tolerance)
    {
        return arrayLastIndexOf(array, floatToFind, Integer.MAX_VALUE,
                tolerance);
    }
     ...
     * @return
     */
    public static double[] arrayMerge(final double[] array1, final double[] array2) {
    	double[] ret = null;
    	if(!isEmptyArray(array1) && !isEmptyArray(array2)) {
    		ret = new double[array1.length + array2.length];
    		System.arraycopy(array1, 0, ret, 0, array1.length);
    	    System.arraycopy(array2, 0, ret, array1.length, array2.length);
    	} else {
    		ret = isEmptyArray(array1) && isEmptyArray(array2) ? null : (isEmptyArray(array1) ? array2 : array1);
    	}
    	return ret;
    }
     ...
     * @return
     */
    public static float[] arrayMerge(final float[] array1, final float[] array2) {
    	float[] ret = null;
    	if(!isEmptyArray(array1) && !isEmptyArray(array2)) {
    		ret = new float[array1.length + array2.length];
    		System.arraycopy(array1, 0, ret, 0, array1.length);
    	    System.arraycopy(array2, 0, ret, array1.length, array2.length);
    	} else {
    		ret = isEmptyArray(array1) && isEmptyArray(array2) ? null : (isEmptyArray(array1) ? array2 : array1);
     ...
     * @return
     */
    public static int[] arrayMerge(final int[] array1, final int[] array2) {
    	int[] ret = null;
    	if(!isEmptyArray(array1) && !isEmptyArray(array2)) {
    		ret = new int[array1.length + array2.length];
    		System.arraycopy(array1, 0, ret, 0, array1.length);
    	    System.arraycopy(array2, 0, ret, array1.length, array2.length);
    	} else {
    		ret = isEmptyArray(array1) && isEmptyArray(array2) ? null : (isEmptyArray(array1) ? array2 : array1);
     ...
     * @return
     */
    public static char[] arrayMerge(final char[] array1, final char[] array2) {
    	char[] ret = null;
    	if(!isEmptyArray(array1) && !isEmptyArray(array2)) {
    		ret = new char[array1.length + array2.length];
    		System.arraycopy(array1, 0, ret, 0, array1.length);
    	    System.arraycopy(array2, 0, ret, array1.length, array2.length);
    	} else {
    		ret = isEmptyArray(array1) && isEmptyArray(array2) ? null : (isEmptyArray(array1) ? array2 : array1);
     ...
     * @return
     */
    public static short[] arrayMerge(final short[] array1, final short[] array2) {
    	short[] ret = null;
    	if(!isEmptyArray(array1) && !isEmptyArray(array2)) {
    		ret = new short[array1.length + array2.length];
    		System.arraycopy(array1, 0, ret, 0, array1.length);
    	    System.arraycopy(array2, 0, ret, array1.length, array2.length);
    	} else {
    		ret = isEmptyArray(array1) && isEmptyArray(array2) ? null : (isEmptyArray(array1) ? array2 : array1);
     ...
     * @return
     */
    public static long[] arrayMerge(final long[] array1, final long[] array2) {
    	long[] ret = null;
    	if(!isEmptyArray(array1) && !isEmptyArray(array2)) {
    		ret = new long[array1.length + array2.length];
    		System.arraycopy(array1, 0, ret, 0, array1.length);
    	    System.arraycopy(array2, 0, ret, array1.length, array2.length);
    	} else {
    		ret = isEmptyArray(array1) && isEmptyArray(array2) ? null : (isEmptyArray(array1) ? array2 : array1);
     ...
     * @return
     */
    public static byte[] arrayMerge(final byte[] array1, final byte[] array2) {
    	byte[] ret = null;
    	if(!isEmptyArray(array1) && !isEmptyArray(array2)) {
    		ret = new byte[array1.length + array2.length];
    		System.arraycopy(array1, 0, ret, 0, array1.length);
    	    System.arraycopy(array2, 0, ret, array1.length, array2.length);
    	} else {
    		ret = isEmptyArray(array1) && isEmptyArray(array2) ? null : (isEmptyArray(array1) ? array2 : array1);
     ...
     * @return
     */
    public static String[] arrayMerge(final String[] array1, final String[] array2) {
    	String[] ret = null;
    	if(!isEmptyArray(array1) && !isEmptyArray(array2)) {
    		ret = new String[array1.length + array2.length];
    		System.arraycopy(array1, 0, ret, 0, array1.length);
    	    System.arraycopy(array2, 0, ret, array1.length, array2.length);
    	} else {
    		ret = isEmptyArray(array1) && isEmptyArray(array2) ? null : (isEmptyArray(array1) ? array2 : array1);
     ...
     * @return
     */
    public static Object[] arrayMerge(final Object[] array1, final Object[] array2) {
    	Object[] ret = null;
    	if(!isEmptyArray(array1) && !isEmptyArray(array2)) {
//    		Iterator<Object> arrayIterator1= new ArrayIterable<Object>(array1.length)
//            {
//                @Override
...
//                		return null;
//                	}
//                    return array1[i].getClass().cast(array1[i]);
//                }
//            }.iterator();
//            
//            Iterator<Object> arrayIterator2= new ArrayIterable<Object>(array2.length)
//            {
//                @Override
//                protected Object get(int i)
//                {
...
//                		return null;
//                	}
//                    return array2[i].getClass().cast(array2[i]);
//                }
//            }.iterator();
//            
//            Collection<Object> list = createLinkedHashSet();
//			while(arrayIterator1.hasNext()) {
//				list.add(arrayIterator1.next());
//			}
//			while(arrayIterator2.hasNext()) {
//				list.add(arrayIterator2.next());
//			}
//			ret = list.toArray();
				
				
    		ret = new Object[array1.length + array2.length];
    		System.arraycopy(array1, 0, ret, 0, array1.length);
    	    System.arraycopy(array2, 0, ret, array1.length, array2.length);
    	} else {
    		ret = isEmptyArray(array1) && isEmptyArray(array2) ? null : (isEmptyArray(array1) ? array2 : array1);
