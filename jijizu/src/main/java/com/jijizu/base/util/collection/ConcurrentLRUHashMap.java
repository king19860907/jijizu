...
/**
 * 遵循LRU原则的Map类。<br/>
 * 参考<code>java.util.concurrent.ConcurrentHashMap</code>的实现，加入LRU算法控制。<br/>
 * 
 * @author luke_huang
 * @since 2011-07-20
 * 
        ...
        ConcurrentMap<K, V>, Serializable
{
	 ...
	 * 
	 */
    private static final long serialVersionUID = -4075402246124889182L;
     ...
     * 位操作的段位。<br/>
     * <p>
     * 基于<code>java.util.concurrent.ConcurrentHashMap.HashEntry</code>的修改。<br/>
     * 内部实现一个双向列表。
     * </p>
     * 
     * @author luke_huang
     ...
     * 位操作的段位。<br/>
     * <p>
     * 基于<code>java.util.concurrent.ConcurrentHashMap.Segment</code>的修改。<br/>
     * 内部实现一个双向列表。
     * </p>
     * 
     * @author luke_huang
