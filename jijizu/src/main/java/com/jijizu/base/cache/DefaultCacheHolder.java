 ...
 * 
 * <pre>
 * <bean id="defaultCacheHolder" class="com.yesmynet.cache.DefaultCacheHolder" destroy-method="destroy">
 *       <property name="cache">
 ...
 * @since 2011-06-14
 */
public class DefaultCacheHolder implements InitializingBean, DisposableBean {

	protected static Logger logger = LoggerFactory.getLogger(DefaultCacheHolder.class);
	...
	public static void main(String[] args) throws Exception {
		Cache cache = new CacheMemcachedDefaultImpl(
				new String[] { "192.168.0.133:12000" }, new int[] { 1 }, 1,
				false, "cache_demo");

		DefaultCacheHolder cacheHolder = new DefaultCacheHolder();

		cacheHolder.setCache(cache);

		HashSet<Object> keyCondition = createHashSet();
		// keyCondition.add("dfghdfh");
		// keyCondition.add(new Object());
		keyCondition.add(new HashSet<Object>());

		cacheHolder.add(keyCondition, "43546");
		cacheHolder.add(keyCondition, keyCondition, "2mn");

		TimeUnit.SECONDS.sleep(2000);
		// Object obj = cacheHolder.get(keyCondition);
