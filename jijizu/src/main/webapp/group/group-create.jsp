...
<title>发起集集组-集集组是一个平台，方便家长组织好友，带着孩子们聚在一起，玩耍、交流、分享。</title>
      	...
      	<div class="jjz_left_box">
            ...
            <div class="ev_notice_area">
            	<dl>
                    ...
                    <dd>
                    	<input name="title" type="text" class="W_input" id="title" />
                ...
                <dl>
                	<dt>活动时间<font color="red">*</font></dt>
                ...
                <dl>
                    ...
                    <dd>
                    	<textarea name="groupDesc" id="groupDesc" cols="" rows="" class="editor_Cont"></textarea>
                        <div class="notice_area">最多输入2000个字</div>
                        <div class="M_notice_del"><span class="icon_del"></span><span class="txt">已超过最大字数</span></div>
                    </dd>
                </dl>
                <dl>
                	<dt>上传海报<font color="red" style="display:none">*</font></dt>
                    <dd>
                    		...
                    		<input type="hidden" id="post_status_media_url" name="posterImgUrl"/>
                    		<img width="60" height="80" style="display:none" id="post_status_media_img" src=""/>
                    </dd>
                    <dt></dt>
                    <dd></dd>
                </dl>
                <dl>
                    ...
                    <dd class="select_area">
                        ...
                        <input id="address" name="address" type="text" class="editor_add" />
                    </dd>
                </dl>
                <dl>
                	<dt>参加人数</dt>
                    <dd><label><input type="radio" name="people" checked="checked" value="0" class="W_radio"/>不限</label>
                    	<input id="ev_radio14" type="radio" name="people" value="1" class="W_radio"/>
                    	<label for="ev_radio14">最多</label><input id="applyNum" name="applyNum" class="input41" maxlength="9" /><label>人报名</label>
                        <label><input type="checkbox" name="onlyOne" class="checkbox" value="1" id="parent_onlyone"/>仅限一位大人</label>
                        <select class="Parents" name="parentsLimit">
                          <option value="GROUP_PARENTS_LIMIT_MOTHER">妈妈</option>
                          <option value="GROUP_PARENTS_LIMIT_FATHER">爸爸</option>
                        </select>
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd>
                    	<div class="ctrl"><input type="text" id="startAge" name="startAge" value="" class="age one"/>-<input type="text" id="endAge" name="endAge" value="" class="age two"/>岁</div>
                    </dd>
                </dl>
                <dl>
                	<dt>人均费用<font color="red">*</font></dt>
                    <dd>
                    	<input type="radio" id="ev_radio1" class="W_radio" value="1" name="fee"/>
                    	<label for="ev_radio1">费用为</label><input id="cost" name="cost" maxlength="9" class="input41" id="feenum"/><label>元</label> 
                    	<input type="radio" checked="checked" id="ev_radio0" class="W_radio" value="0" name="fee"/><label for="ev_radio0">免费</label>
                    </dd>
                </dl>
                <dl>
                	<dt>参加权限<font color="red">*</font></dt>
                    <dd>
                    	<p><input type="radio" name="enterType" value="GROUP_ENTER_TYPE_PUBIC" checked="checked"  id="ev_radio3" class="W_radio"/><label for="ev_radio3">公开招募</label></p>
                    	<p><input type="radio" name="enterType" value="GROUP_ENTER_TYPE_FRIENDS" id="ev_radio5" class="W_radio"/><label for="ev_radio5">仅限于好友</label>
                    		<select name="enterTypeDetail">
                              <option value="GROUP_ENTER_TYPE_DETAIL_NOT_NEED_AUDIT">不需要审核</option>
                              <option value="GROUP_ENTER_TYPE_DETAIL_NEED_AUDIT">需要审核</option>
                            </select>
                    	</p>
                        <p><input type="radio" name="enterType" value="GROUP_ENTER_TYPE_AUDIT" id="ev_radio2" class="W_radio"/><label for="ev_radio2">发起人审核</label></p>
                        <p><input type="radio" name="enterType" value="GROUP_ENTER_TYPE_INVITE" id="ev_radio4" class="W_radio"/><label for="ev_radio4">发起人秘密邀约</label></p>
                    </dd>
                </dl>
            </div>
            <div id="pl_ev_next" class="ev_next">
            	<a class="W_btn_d" id="add-group-btn" href="javascript:void(0);">发布集集组</a>
            </div>
        </div>
      </div>
      <!--右边-->
