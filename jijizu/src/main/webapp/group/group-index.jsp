       ...
       <s:if test="groupPage.pageCnt>1">
					<div class="W_pages_minibtn">
						<s:if test="groupPage.befPageNum>0 && groupPage.curPageNum!=1">      	
						   <a href="/group/?page=<s:property value="groupPage.befPageNum" />" class="btn_page">上一页</a>
						</s:if>
						<s:iterator value="groupPage.pageList" id="curPage">
							...
							<s:else>
								<a href="/group/?page=<s:property value="#curPage" />"><s:property value="#curPage" /></a>
							</s:else>
						</s:iterator>
						   <s:if test="groupPage.curPageNum!=groupPage.pageCnt">
						   <a href="/group/?page=<s:property value="groupPage.aftPageNum" />" class="btn_page">下一页</a>
						   </s:if>
					</div>
			</s:if>
