...
<form action="" id="add-diary-form">
	<input id="child-id-hidden" type="hidden" name="childId" value="<s:property value="childId"/>"/>
	<input id="diary-type-hidden" type="hidden" name="diaryType" value="<s:property value="diaryType"/>" />
	<div class="top"></div>
    <div class="center clearfix">
    	<div class="little_book_nav">
            ...
            <dl class="date">
            	...
            	<dd>
                	<input class="date" type="text" id="diaryDate"
												name="diaryDate"
												value="<s:date name="diaryDate" format="yyyy-MM-dd" />" />
              	</dd>
            </dl>
            <dl class="lable">
            	<dt>选择标签</dt>
            ...
            <s:if test="childList!= null && childList.size > 0">
	                ...
	                <span>
	                			<select id="child-select">
	                				<s:iterator value="childList">
		                				<option value="<s:property value="childId"/>"><s:property value="name"/></option>
	                				</s:iterator>
	                			</select>
	                </span>
	            </div>
	            <dl class="tag" id="Height_content" name="tag_content">
			    	...
			    	<dd class="clearfix">
	                    ...
	                    <li><span class="details_title">身高：</span><span><input name="height" type="text" class="height_unit" value="" />公分</span></li>
	              	</dd>
	            </dl>
	            <dl class="tag" id="Weight_content" name="tag_content">
			    	...
			    	<dd class="clearfix">
	                    ...
	                    <li><span class="details_title">体重：</span><span><input name="weight" type="text" class="height_unit" value="" />公斤</span></li>
	              </dd>
	            </dl>
	            <dl class="tag" id="MilkPowder_content" name="tag_content">
			    	...
			    	<dd class="clearfix">
	                    ...
	                    <li><span class="details_title">奶粉品牌：</span><span><input type="text" class="txt" value="" id="milkName" name="milkName" /></span></li>
	                    <li><span class="details_title">今天共吃：</span><span><input type="text" class="txt" value="" name="milkMl" />ml</span></li>
	              </dd>
	            </dl>
	            <dl class="tag" id="Sick_content" name="tag_content">
			    	...
			    	<dd class="clearfix">
	                    ...
	                    <li>
	                        ...
	                        <span class="prompt">
                            <input type="text" value="" id="sickName" name="sickName" class="txt">
                        </span>
	                    </li>
	                    <li><span class="details_title">是否痊愈：</span><span><input name="recoveryFlag" type="radio" class="radio" value="1" /><em>是</em><input name="recoveryFlag" type="radio" class="radio" value="0" checked="checked" /><em>否</em></span></li>
	              </dd>
	            </dl>
			    	...
			    	<dd class="clearfix">
	                	...
	                	<li><span class="details_title">第一次：</span><span>
	                		<select name="firstTimeType" id="firstTimeType">
	                			<option value="FIRST_TIME_TYPE_TRUN_OVER">翻身</option>
	                			<option value="FIRST_TIME_TYPE_SIT_UP">坐起</option>
	                			<option value="FIRST_TIME_TYPE_CRAWL">爬行</option>
	                			<option value="FIRST_TIME_TYPE_CALL_MOM">叫妈妈</option>
	                			<option value="FIRST_TIME_TYPE_CALL_DAD">叫爸爸</option>
	                			<option value="FIRST_TIME_TYPE_STAND">站立</option>
	                			<option value="FIRST_TIME_TYPE_WALK">行走</option>
	                		</select></span></li>
	                    <li><span class="details_title">出生后：</span><span>第<input type="text" value="" name="firstDay" class="height_unit"/>天第一次<span id="first-time-str">翻身</span></span></li>
	              </dd>
	            </dl>
            ...
            <s:else>
            	<dl class="tag" id="Height_content" name="tag_content">
	            	<font color="#666666">请</font><a onclick="return show_login(this);" href="/user/base.jspa" style="color:#0179B5;">点击这里</a><font color="#666666">完善孩子信息后方能进行操作</font>
	            </dl>
	            <dl class="tag" id="Weight_content" name="tag_content">
	            		<font color="#666666">请</font><a onclick="return show_login(this);" href="/user/base.jspa" style="color:#0179B5;">点击这里</a><font color="#666666">完善孩子信息后方能进行操作</font>
	            </dl>
        ...
        <div class="little_book_right">
        	<div class="little_book_content">
            	<div class="little_book_title">
                	<h3><input type="text" name="title" value="添加标题" id="title" onfocus="if(value=='添加标题') {value=''}" onblur="if (value=='') {value='添加标题'}" /></h3>
                    <div class="btns">
                        <a id="add-diary-btn" title="保存" href="javascript:void(0)"><img alt="保存" src="${IMG_PATH}/little_book_icon02.jpg" /></a>
                ...
                <div class="textarea">
                	...
                	<textarea id="text" cols="" rows="5" name="content"></textarea>
                </div>
                <div class="btnf clearfix">
                    <div class="icon_detail">
 						...
 						<label class="share"><input name="notShowFlag" type="checkbox" value="0" />分享到集集组微博</label>
                    </div>
                </div>
                <div id="graph"></div>
            </div>
